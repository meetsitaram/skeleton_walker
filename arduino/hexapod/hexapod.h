...
const double coxa = 6.0; // shoulder distance from center
...
const int SHIELD1_PULSE_OFFSET = -20; // Unbelievable. Needed this as
...
const int initThetaN11 = 45;
const int initThetaN21 = 45;
const int initThetaN31 = 45;
const int initThetaN41 = 45;
const int initThetaN51 = 45;
const int initThetaN61 = 45;

const int initThetaN12 = 120;
const int initThetaN22 = 120;
const int initThetaN32 = 120;
const int initThetaN42 = 120;
const int initThetaN52 = 120;
const int initThetaN62 = 120;
